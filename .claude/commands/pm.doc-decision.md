...
Invoke the founding-product-manager agent to work with human on documenting a product decision.

Use Task tool with `subagent_type: founding-product-manager` and prompt:
