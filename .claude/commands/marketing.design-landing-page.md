...
Use the **landing-page-expert** agent (Task tool, subagent_type: landing-page-expert) to:

1. **Gather Context** - Read product docs, research, requirements
...
**Reference**: `/docs/marketing/landing-page/yc-landing-strategy.md`
