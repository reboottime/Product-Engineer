...
**Prompt**: "Write PRD for $ARGUMENTS defining WHAT to build and WHY. Verify validation exists, gather context, and write to `/docs/product/requirements/[platform].$ARGUMENTS.md` (e.g., `chrome-extension.feature-name.md`). After writing PRD, update `/docs/product/requirements/index.md` by reading all PRD frontmatter and creating summary table (feature, platform, status, priority, owner, last_updated). Offer to spawn founding-product-design-lead for UX design."
